 ...
 * PageStateCard
 *
 * Small reusable “safe fallback” UI for cases where a page
 * cannot render yet (missing orgSlug, invalid route param, etc.).
 *
 * Keeps page components short and consistent.
 */
