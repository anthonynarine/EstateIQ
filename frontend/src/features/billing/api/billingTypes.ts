 ...
 *
 * The frontend uses an explicit month anchor so the transport layer can send
 * the canonical backend request contract without guessing.
 */
 ...
 *
 * This now matches the richer backend response shape:
 * - whether a charge was newly created
 * - whether the month already existed
 * - the canonical month anchor
 * - a user-facing message for the panel
 */
